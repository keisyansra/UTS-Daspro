...
public class UprakDaspro3 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.println("Masukkan jumlah calon mahasiswa baru : ");
        int jumlahCalonMahasiswaBaru = sc.nextInt();
        
            for (int i = 1; i <= jumlahCalonMahasiswaBaru; i++ ) {
